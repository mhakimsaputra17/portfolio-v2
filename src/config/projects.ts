...
export const projects = [
  {
    ...
    preview: "/images/projectimage/project1.jpg",
  ...
  },
  {
    ...
    preview: "/images/projectimage/tickitz.png",
    tech: ["React", "TailwindCSS", "Go", "PostgreSQL", "Redis"],
    featured: true,
  },
  {
    name: "Preferences Ai",
    ...
    preview: "/images/projectimage/preferences-claude.png",
    tech: [
      "React",
      "TailwindCSS",
      "Python",
  ...
  {
    name: "PdfImageTools",
    desc: "PdfImageTools is a powerful web application that allows users to extract images from PDF files and convert images to PDF format. Built with a modern tech stack, it offers a seamless user experience and efficient image processing capabilities.",
    github: "https://github.com/mhakimsaputra17/PdfImageTools",
    demo: "https://pdfimagetools.mhakimsaputra.me/",
    preview: "/images/projectimage/pdfimgtools.png",
    tech: ["Next.js", "TailwindCSS", "pdf-lib"],
    featured: true,
  },
  // {
  //   name: "SQL Editor",
  ...
  },
  {
    ...
    demo: "https://github.com/mhakimsaputra17",
    preview: "",
    tech: ["Python", "OpenAI", "RICH"],
    featured: false,
  },
  {
    name: "Web Scraping for Marketplace Price Trends",
    desc: "Developed Python scripts to extract and monitor product price history data from leading Indonesian e-commerce platforms. Enabled the collection of graphical price data for trend analysis, facilitating informed purchasing decisions.",
    github: "https://github.com/mhakimsaputra17",
    demo: "https://github.com/mhakimsaputra17",
    preview: "",
    tech: ["React", "Flask", "Playwright", "Bright Data"],
    featured: false,
  },
  {
    name: "Discord Music Bot",
    desc: "Engineered a Discord bot using Python and the discord.py library to stream music within voice channels. Implemented core features such as song queuing, playback controls (play, pause, skip), and music search functionality, enhancing server engagement.",
    github: "https://github.com/mhakimsaputra17",
    demo: "https://github.com/mhakimsaputra17",
    preview: "",
  ...
  {
    name: "Automated Flash Sale Bot",
    desc: "Designed and implemented a Python and Selenium-based bot to automate the process of purchasing limited-stock items during high-demand online flash sales. The bot efficiently navigated e-commerce websites, identified target products, and expedited the checkout process to maximize acquisition success.",
    github: "https://github.com/mhakimsaputra17",
    demo: "https://github.com/mhakimsaputra17",
    preview: "",
  ...
  {
    name: "WhatsApp Bot for Prayer Times",
    desc: "Applied an automated system using Puppeteer to scrape prayer time data from reliable sources based on the user's location. Employed WhatsApp-web.js to create a conversational bot interface, allowing users to input their location, choose prayer time options, and receive accurate prayer time information directly on their WhatsApp.",
    github: "https://github.com/mhakimsaputra17",
    demo: "https://github.com/mhakimsaputra17",
    preview: "",
  ...
  {
    name: "Inspeksi dan Validasi Data",
    desc: "Improved and delivered a robust data inspection and validation system for Balai Monitor Spektrum Frekuensi Radio Kelas II Pontianak, ensuring the accuracy and integrity of collected data. Utilized Node.js and Express.js for backend infrastructure, integrated MongoDB for efficient data storage, and implemented JWT for secure authentication.",
    github: "https://github.com/mhakimsaputra17",
    demo: "https://github.com/mhakimsaputra17",
    preview: "",
    tech: [
